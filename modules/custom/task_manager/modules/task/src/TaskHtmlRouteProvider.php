...
/**
 * @file
 * Contains \Drupal\task\TaskHtmlRouteProvider.
 */
...
class TaskHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\task\Controller\TaskAddController::addForm',
          '_title_callback' => 'Drupal\task\Controller\TaskAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\task\Controller\TaskAddController::add',
