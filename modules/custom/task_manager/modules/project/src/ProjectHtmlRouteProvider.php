...
/**
 * @file
 * Contains \Drupal\project\ProjectHtmlRouteProvider.
 */
...
class ProjectHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\project\Controller\ProjectAddController::addForm',
          '_title_callback' => 'Drupal\project\Controller\ProjectAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\project\Controller\ProjectAddController::add',
