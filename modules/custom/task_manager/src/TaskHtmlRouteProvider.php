...
/**
 * @file
 * Contains \Drupal\task_manager\TaskHtmlRouteProvider.
 */
...
class TaskHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\task_manager\Controller\TaskAddController::addForm',
          '_title_callback' => 'Drupal\task_manager\Controller\TaskAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\task_manager\Controller\TaskAddController::add',
  ...
  protected function getSettingsFormRoute(EntityTypeInterface $entity_type) {
    if (!$entity_type->getBundleEntityType()) {
      ...
      $route
        ->setDefaults([
          '_form' => 'Drupal\task_manager\Form\TaskSettingsForm',
